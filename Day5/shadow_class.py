...
class ShadowClass(Monsters):
    def __init__(self, sprite, sprite_x, sprite_y, x_speed, y_speed, screen):
        ...
        self._shadow_list = []
        super().set_rect(pygame.Rect(constants.SHADOW_X, constants.SHADOW_Y, constants.SCREEN_WIDTH, super().get_height()))
    ...
    def upload(self):
        for counter in range(constants.SHADOW_NUMBER):
            ...
            self._screen.blit(super().get_sprite(), (constants.SHADOW_DISTANCE * counter, super().get_rect().y))
